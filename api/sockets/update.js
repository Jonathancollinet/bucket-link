...
let forceUpdate = async (socket, roomName)=>{
  let userRooms = {};
  console.log('rooms', roomName)
  console.log('u', socket.u);
   if(roomName in serverRooms){
      if(!userRooms[roomName]) { userRooms[roomName]= []}
      userRooms[roomName].push(socket.u.id);
    }
